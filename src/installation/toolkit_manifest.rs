...
mod test_get_tookits_manifest {
    ...
    async fn test_with_remote_file() -> Result<()> {
        let toolkits_manifest = get_tookits_manifest("https://gist.githubusercontent.com/luhc228/6980b3e72e66066c8d27ef7b3f66580b/raw/a47a3c0b68b5fedf62cd0f7a43c0bc2c224d4d60/toolkit.config.json").await?;
        assert!(toolkits_manifest.tools.len() == 3);
        Ok(())
    }
}
